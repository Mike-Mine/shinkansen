...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <form v-if="editing" @submit.prevent="form.put(route('comments.update', comment.id), { onSuccess: () => editing = false })">
            ...
            <p v-else class="mt-4 text-lg text-gray-900">{{ comment.message }}</p>
        </div>
    </div>
</template>